...
class PomodoroTimer:
    ...
    def main(self):
        ...
        # display
        self.set_minute_display = Label(
            self.window, textvariable=self.min_, font=("bold", 30)
        ).place(x=100, y=120, width=200, height=100)
        self.set_seconds_display = Label(
            self.window, textvariable=self.sec, font=("bold", 30)
        ).place(x=400, y=120, width=200, height=100)
