...
label_down = Label(
    lower_frame, font=FONT, fg="#001a4d", anchor="nw", justify="left", bd=4
)
...
# For Options menu
options = ["BTC", "USD", "EUR", "INR", "GBP", "AUD", "CAD", "CHF", "RUB", "CNY", "JPY"]
