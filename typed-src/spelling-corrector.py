...
img = ImageTk.PhotoImage(
    Image.open(r"C:\Users\FUTURE LAPTOP\Downloads\Spelling Corrector.png")
)
label = Label(root, image=img)
label.place(relx=0.5, rely=0.12, anchor=CENTER)

img2 = ImageTk.PhotoImage(
    Image.open(r"C:\Users\FUTURE LAPTOP\Downloads\Untitled design.png")
)
label2 = Label(root, image=img2)
label2.place(relx=0.58, rely=0.82, anchor=W)

my_frame = LabelFrame(
    root, text="Correct Spellings", font=("Roboto", 15), fg="#000000", padx=100, pady=10
)
my_frame.pack(padx=15, pady=150)

Label(my_frame, text="Your Word: ", font=("Roboto", 15), padx=7, relief="groove").grid(
    row=0, column=0, columnspan=2, padx=2, pady=5, sticky="W"
)
...
def clicked(word):
    ...
    Label(
        my_frame, text="Correct Word: ", font=("Roboto", 15), padx=7, relief="groove"
    ).grid(row=2, column=0, columnspan=2, padx=2, pady=5, sticky="W")

    Label(my_frame, text=corrected, font=("Roboto", 15), padx=7, relief="groove").grid(
        row=2, column=2, padx=2, pady=5, sticky="W"
    )
