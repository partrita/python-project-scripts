...
def entered():
    ...
    entry_lbl1["text"] = choice.split("to")[0]
    entry_lbl2["text"] = choice.split("to")[1]
    entry_lbl1.grid(row=1, column=0)
    entry_lbl2.grid(row=2, column=0)
