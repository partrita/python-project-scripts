...
raw_data = get_data(
    "https://weather.com/en-IN/weather/today/l/e1bbaf5ba44a74170e3bb9f892416301c36b3b17f37e1a666c6e1213de0f5668"
)
...
city = city.split(",")
notification.notify(
    title=city[0] + " weather update", message=weather_update, timeout=5, app_icon=None
)
