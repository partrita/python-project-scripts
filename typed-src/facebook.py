...
class Post:
    ...
    def comment_on_a_post(post_id, u_id, u_obj):
            ...
            if is_page_post:
                ...
                if access:
                    ...
                    Button(
                        ...
                        font=("Roboto", 13),
                        fg="#1877F2",
                        command=lambda: commenting.destroy(),
                    ).grid(row=3, column=0, pady=5, sticky="W")
                else:
                    Label(
                        pc_frame,
                        text="You can't comment on this post.",
                        font=("Roboto", 15),
                        padx=7,
                        relief="groove",
                    ).grid(row=2, column=0, columnspan=2, padx=4, pady=5, sticky="W")
        ...
        Label(pc_frame, text="Enter Comment: ", font=("Roboto", 15), padx=7).grid(
            row=0, column=0, columnspan=2, padx=4, pady=5, sticky="W"
        )
...
class User:
    ...
    def sign_up(self):
        ...
        my_frame4 = LabelFrame(
            top3, text="Sign Up", font=("Roboto", 15), fg="#1877F2", padx=50, pady=40
        )
        ...
        def clicked():
            ...
            if repetition:
                ...
                Button(
                    ...
                    bg="#1877F2",
                    fg="white",
                    command=lambda: login_instead(user_obj),
                ).grid(row=4, column=0, columnspan=2, pady=12, sticky="W")
                ...
                Label(my_frame5, text="Password", font=("Roboto", 15), padx=7).grid(
                    row=0, column=0, columnspan=2, padx=4, pady=5, sticky="W"
                )
                Label(my_frame5, text="First Name", font=("Roboto", 15), padx=7).grid(
                    row=1, column=0, columnspan=2, padx=4, pady=5, sticky="W"
                )
                Label(my_frame5, text="Last Name", font=("Roboto", 15), padx=7).grid(
                    row=2, column=0, columnspan=2, padx=4, pady=5, sticky="W"
                )
                Label(my_frame5, text="Gender", font=("Roboto", 15), padx=7).grid(
                    row=3, column=0, columnspan=2, padx=4, pady=(5, 0), sticky="W"
                )
                Label(
                    my_frame5, text="Date of Birth", font=("Roboto", 15), padx=7
                ...
                def sign_up_now():
                    ...
                    if (
                        user_password.index("end") == 0
                        or user_first_name.index("end") == 0
                        or user_last_name.index("end") == 0
                    ):
                        l1.grid(
                            row=8, column=0, columnspan=2, pady=5, padx=3, sticky="W"
                        )
                        ...
                        Label(
                            my_frame5, text="You're signed in!", font=("Roboto", 15)
                        ).grid(
                            row=8, column=0, columnspan=2, pady=5, padx=3, sticky="W"
                        )
                        ...
                        Button(
                            ...
                            bg="#1877F2",
                            fg="white",
                            command=lambda: login_after_signup(user_obj),
    ...
    def login(self):
        ...
        my_frame2 = LabelFrame(
            top, text="Login", font=("Roboto", 15), fg="#1877F2", padx=50, pady=40
        )
        ...
        def info_entered():
            ...
            with open("Users_Database.csv") as data_file:
                ...
                for row in csv_reader:
                    if row[3] == email_phone:
                        ...
                        self.gender, self.dob, self.about, self.current_city = (
                            row[5],
                            row[6],
                            row[7],
                            row[8],
                        )
                        self.Education, self.Workplace, self.Relationship_Status = (
                            row[9],
                            row[10],
                            row[11],
                        )
            ...
            if registered:
                ...
                if match:
                    Label(
                        my_frame2, text="You are Logged in!", font=("Roboto", 12)
                    ).grid(row=3, column=0, columnspan=2, sticky="W")
                    ...
                    Label(profile_info, text="About:", font=("Roboto", 12)).grid(
                        row=1, column=0, pady=3, sticky="W"
                    )
                    Label(profile_info, text=self.about, font=("Helvetica", 12)).grid(
                        row=1, column=1, pady=3, sticky="W"
                    )
                    Label(
                        profile_info, text="Current City: ", font=("Roboto", 12)
                    ).grid(row=2, column=0, pady=3, sticky="W")
                    Label(
                        profile_info, text=self.current_city, font=("Helvetica", 12)
                    ).grid(row=2, column=1, pady=3, sticky="W")
                    Label(profile_info, text="Education: ", font=("Roboto", 12)).grid(
                        row=3, column=0, pady=3, sticky="W"
                    )
                    Label(
                        profile_info, text=self.Education, font=("Helvetica", 12)
                    ).grid(row=3, column=1, pady=3, sticky="W")
                    Label(profile_info, text="Workplace: ", font=("Roboto", 12)).grid(
                        row=4, column=0, pady=3, sticky="W"
                    )
                    Label(
                        profile_info, text=self.Workplace, font=("Helvetica", 12)
                    ).grid(row=4, column=1, pady=3, sticky="W")
                    Label(
                        profile_info, text="Relationship Status: ", font=("Roboto", 12)
                    ).grid(row=5, column=0, pady=3, sticky="W")
                    Label(
                        profile_info,
                        text=self.Relationship_Status,
                        font=("Helvetica", 12),
                    ).grid(row=5, column=1, pady=3, sticky="W")

                    # Displaying user's posts.
                    profile_posts = LabelFrame(
                        home,
                        text="Posts",
                        font=("Roboto", 15),
                        fg="#1877F2",
                    ...
                    if has_posts:
                        ...
                        description_label = Label(
                            profile_posts,
                            text=psdescription[post_num - 1],
                            font=("Helvetica bold 18", 13),
                            padx=7,
                            pady=3,
                        )
                    ...
                    if not has_posts:
                        ...
                        Label(
                            profile_posts, text="You've no posts.", font=("Roboto", 14)
                    ...
                    Button(
                        ...
                        width=14,
                        font=("Roboto", 13),
                        command=lambda: see_messages(user_obj),
                    ...
                    Button(
                        ...
                        width=14,
                        font=("Roboto", 13),
                        command=lambda: see_friends(user_obj),
                    ...
                    def account_privacy():
                        ...
                        privacy.iconbitmap(
                            r"C:\Users\FUTURE LAPTOP\Downloads\fbicon.ico"
                        )
                        ...
                        Button(
                            ...
                            width=14,
                            font=("Roboto", 13),
                            command=lambda: change_privacy(user_obj),
                        ).grid(row=0, column=0, pady=5, sticky="W")
                        # Block a user.
                        Button(
                            pr_frame,
                        ...
                        Button(
                            ...
                            width=14,
                            font=("Roboto", 13),
                            command=lambda: unblock(user_obj),
                        ...
                        Button(
                            ...
                            font=("Roboto", 13),
                            fg="#1877F2",
                            command=lambda: privacy.destroy(),
                    ...
                    def settings():
                        ...
                        Button(
                            ...
                            width=14,
                            font=("Roboto", 13),
                            command=lambda: edit_profile(user_obj),
                        ).grid(row=0, column=0, pady=5, sticky="W")
                        # Change account privacy.
                        Button(
                            set_frame,
                        ...
                        Button(
                            ...
                            font=("Roboto", 13),
                            fg="#1877F2",
                            command=lambda: delete_profile(user_obj),
                        ).grid(row=2, column=0, pady=5, sticky="W")
                        # Back.
                        Button(
                            set_frame,
                    ...
                    def search():
                        ...
                        Button(
                            ...
                            width=14,
                            font=("Roboto", 13),
                            command=lambda: search_a_user(user_obj),
                        ).grid(row=0, column=0, pady=5, sticky="W")
                        # Search a page.
                        Button(
                            search_frame,
                            ...
                            width=14,
                            font=("Roboto", 13),
                            command=lambda: search_a_page(user_obj),
                        ).grid(row=1, column=0, pady=5, sticky="W")
                        # Back.
                        Button(
                            search_frame,
                    ...
                    Button(
                        ...
                        width=14,
                        font=("Roboto", 13),
                        command=lambda: send_request(user_obj),
                    ...
                    Button(
                        ...
                        width=14,
                        font=("Roboto", 13),
                        command=lambda: send_message(user_obj),
                    ...
                    Button(
                        ...
                        font=("Roboto", 13),
                        fg="#1877F2",
                        command=lambda: log_out(user_obj),
                    ...
                    Button(
                        ...
                        width=14,
                        font=("Roboto", 13),
                        command=lambda: create_post(user_obj),
                    ).grid(row=0, column=0, pady=4, sticky="W")
                    Button(
                        create,
                        text="Page",
                        width=14,
                        font=("Roboto", 13),
                        command=lambda: create_page(user_obj),
                    ).grid(row=1, column=0, pady=4, sticky="W")
                    ...
                    Label(
                        my_frame2, text="Incorrect Information!", font=("Roboto", 13)
                    ...
                    reset_button.grid(
                        row=5, column=0, columnspan=2, pady=10, padx=3, sticky="W"
                    )
                    Label(my_frame2, text="OR", font=("Roboto", 13)).grid(
                        row=6, column=0, columnspan=2, pady=5
                    )
                    try_button.grid(row=7, column=0, columnspan=2, padx=3, sticky="W")

            else:
                Label(my_frame2, text="Sign Up First!", font=("Roboto", 13)).grid(
                ...
                exit_button = Button(
                    my_frame2, text="Exit", width=14, font=("Roboto", 13), fg="#1877F2"
                )

                sign_up_button.grid(
                    row=5, column=0, columnspan=2, pady=10, padx=3, sticky="W"
                )
                Label(my_frame2, text="OR", font=("Roboto", 12)).grid(
    ...
    def edit_user(self):
        ...
        Label(edit_frame, text="About", font=("Roboto", 13), padx=7).grid(
            row=0, column=0, columnspan=2, pady=5, sticky="W"
        )
        Label(edit_frame, text="City", font=("Roboto", 13), padx=7).grid(
            row=1, column=0, columnspan=2, pady=5, sticky="W"
        )
        Label(edit_frame, text="Workplace", font=("Roboto", 13), padx=7).grid(
            row=2, column=0, columnspan=2, pady=5, sticky="W"
        )
        Label(edit_frame, text="Education", font=("Roboto", 13), padx=7).grid(
            row=3, column=0, columnspan=2, pady=5, sticky="W"
        )
        Label(edit_frame, text="Relationship Status", font=("Roboto", 13), padx=7).grid(
        ...
        def edit_now():
            ...
            for lst in range(len(lines)):
                if lines[lst][0] == str(self.ID):
                    lines[lst][7], lines[lst][8], lines[lst][9] = (
                        self.about,
                        self.current_city,
                        self.Education,
                    )
                    lines[lst][10], lines[lst][11] = (
                        self.Workplace,
                        self.Relationship_Status,
                    )
                    break
            ...
            Label(
                edit_frame, text="Profile Updated!", font=("Roboto", 14), pady=8
            ...
            ).grid(row=7, column=0, pady=3, sticky="W")
    ...
    def view_user_friends(self):
        ...
        if has_friends:
            ...
            Label(
                sf_frame,
                text="You've no friends.",
                font=("Roboto", 13),
                padx=20,
                pady=5,
                bd=1,
                relief="groove",
            ).grid(row=0, column=0, columnspan=2, pady=2, padx=3, sticky="W")
    ...
    def change_account_privacy(self):
        ...
        def make_public(obj):
            ...
            Label(ap_frame, text="Status Updated!", font=("Roboto", 13), padx=7).grid(
                row=2, column=0, columnspan=2, pady=5, sticky="W"
            )
            Button(
                ap_frame,
                ...
                font=("Roboto", 13),
                fg="#1877F2",
                command=lambda: account_privacy.destroy(),
            ).grid(row=3, column=0, pady=3, sticky="W")
        ...
        if self.account_privacy == str(True):
            Label(
                ap_frame, text="Your account is private.", font=("Roboto", 13), padx=7
            ...
            Button(
                ...
                width=14,
                fg="#1877F2",
                command=lambda: make_public(user_obj),
            ).grid(row=1, column=0, columnspan=2, padx=4, pady=7, sticky="W")

        else:
            Label(
                ap_frame, text="Your account is public.", font=("Roboto", 13), padx=7
            ).grid(row=0, column=0, columnspan=2, pady=5, sticky="W")
            Button(
                ap_frame,
                text="Make Private",
                ...
                width=14,
                fg="#1877F2",
                command=lambda: make_private(user_obj),
            ).grid(row=1, column=0, columnspan=2, padx=4, pady=7, sticky="W")
    ...
    def user_update(self):
        ...
        def password_entered(new):
            ...
            Button(
                ...
                fg="#1877F2",
                command=lambda: login_again(user_obj),
            ).grid(row=4, column=0, columnspan=3, pady=10, sticky="W")
        ...
        def info_entered():
            ...
            if found:
                ...
                Button(
                    ...
                    width=7,
                    fg="#1877F2",
                    command=lambda: password_entered(new_password.get()),
                ).grid(row=2, column=0, columnspan=3, pady=5, sticky="W")
            else:
                Label(
                    up_frame,
                ...
                Button(
                    ...
                    width=12,
                    fg="#1877F2",
                    command=lambda: try_again(user_obj),
                ).grid(row=3, column=0, columnspan=3, pady=5, sticky="W")
        ...
        def info_entered(name):
            ...
            if users:
                ...
                Label(
                    ...
                    row=row_no + 1, column=0, columnspan=2, pady=10, padx=3, sticky="W"
                )
    ...
    def block_a_user(self):
        ...
        def block_now(user_ID, users, row_no):
            ...
            if not blocked:
                ...
                Label(
                    b_frame, text="User blocked.", font=("Roboto", 13), padx=20, pady=5
                ).grid(row=row_no + 3, column=0, columnspan=3, pady=7, sticky="W")
                # Back.
                Button(
                    b_frame,
                    ...
                    font=("Roboto", 13),
                    fg="#1877F2",
                    command=lambda: block.destroy(),
                ).grid(row=row_no + 4, column=0, pady=3, sticky="W")
            else:
                Label(
                    b_frame,
    ...
    def unblock_a_user(self):
        ...
        def unblock_now(user_ID, users, row_no):
            ...
            if not blocked_user:
                Label(
                    ub_frame,
                    text="You've not blocked this user.",
                    font=("Roboto", 13),
                    padx=20,
                    pady=5,
                ).grid(row=row_no + 3, column=0, columnspan=3, pady=7, sticky="W")
                ...
                Button(
                    ...
                    font=("Roboto", 13),
                    fg="#1877F2",
                    command=lambda: unblock.destroy(),
                ).grid(row=row_no + 4, column=0, pady=3, sticky="W")
            else:
                Label(
                    ub_frame,
        ...
        def info_entered(name):
            ...
            if users:
                ...
                b2 = Button(
                    ...
                    width=7,
                    fg="#1877F2",
                    command=lambda: unblock_now(
                        int(user_to_unblock.get()), users, row_no
                    ),
                )
                b2.grid(row=row_no + 2, column=0, columnspan=3, pady=7, sticky="W")
            else:
    ...
    def post(self, post_id):
        ...
        Label(
            pp_frame, text="Post From", font=("Roboto", 15), padx=7, relief="groove"
        ...
        Radiobutton(
            ...
            value="1",
            fg="#1877F2",
        ).grid(row=1, column=0, pady=7, sticky="W")
        Radiobutton(
            pp_frame,
            text="Page",
            variable=forum,
            ...
            value="0",
            fg="#1877F2",
        ).grid(row=1, column=1, pady=7, sticky="W")
        ...
        def post_in_page(page_ID, thepages, row_no):
            ...
            Label(pp_frame, text="Posted.", font=("Roboto", 13), padx=20, pady=5).grid(
                row=row_no + 3, column=0, columnspan=3, pady=7, sticky="W"
            )
            # Back.
            Button(
                pp_frame,
                ...
                font=("Roboto", 13),
                fg="#1877F2",
                command=lambda: personal_page.destroy(),
            ).grid(row=row_no + 4, column=0, pady=3, sticky="W")
        ...
        def chosen(choice):
            if choice == str(1):
                ...
                Button(
                    ...
                    fg="#1877F2",
                    command=lambda: personal_page.destroy(),
                ).grid(row=4, column=0, pady=3, sticky="W")
                ...
                if your_pages:
                    ...
                    b2 = Button(
                        ...
                        width=7,
                        fg="#1877F2",
                        command=lambda: post_in_page(
                            selected_page.get(), your_pages, row_no
                        ),
                    )
                    b2.grid(row=row_no + 2, column=0, columnspan=3, pady=7, sticky="W")
                else:
        ...
        Button(
            ...
            width=7,
            fg="#1877F2",
            command=lambda: chosen(forum.get()),
    ...
    def create_a_post(self):
        ...
        Label(po_frame, text="Post Type", font=("Roboto", 15), padx=7).grid(
            row=0, column=0, columnspan=2, padx=4, pady=(7, 0), sticky="W"
        )
        Label(po_frame, text="Post Title", font=("Roboto", 15), padx=7).grid(
            row=2, column=0, columnspan=2, padx=4, pady=7, sticky="W"
        )
        Label(po_frame, text="Post Description", font=("Roboto", 15), padx=7).grid(
            row=3, column=0, columnspan=2, padx=4, pady=7, sticky="W"
        )
        Label(po_frame, text="File Path", font=("Roboto", 15), padx=7).grid(
            row=5, column=0, columnspan=2, padx=4, pady=7, sticky="W"
        )
        ...
        def upload_file():
            po_frame.filename = filedialog.askopenfilename(
                initialdir=r"C:\Users\FUTURE LAPTOP\PycharmProjects\Facebook\Images",
                title="Select a File",
                ...
                with open("Posts.csv", "a", newline="") as data_file:
                    ...
                    csv_writer.writerow(
                        [
                            ...
                            post_obj.post_type,
                            post_obj.post_title,
                            post_obj.post_description,
                            post_obj.post_time,
                            post_obj.post_date,
                            post_obj.privacy_id,
                            post_obj.post_notification,
                            post_obj.post_recipients,
                            post_obj.page_id,
                            post_obj.file_path,
                        ]
                    )
        ...
        def send_request(user_ID, users, row_no):
            ...
            if not already_friends:
                ...
                Label(
                    ...
                    row=row_no + 3, column=0, columnspan=2, pady=10, padx=3, sticky="W"
                )
                # Back.
                Button(
                    af_frame,
            ...
            if users:
                ...
                b2 = Button(
                    ...
                    command=lambda: send_request(
                        int(user_to_friend.get()), users, row_no
                    ),
                )
                b2.grid(row=row_no + 2, column=0, columnspan=3, pady=7, sticky="W")
            else:
        ...
        def info_entered(user_name):
            ...
            if users:
                ...
                b2 = Button(
                    ...
                    width=7,
                    fg="#1877F2",
                    command=lambda: type_message(
                        int(user_to_message.get()), users, row_no
                    ),
                )
                b2.grid(row=row_no + 2, column=0, columnspan=3, pady=7, sticky="W")
            else:
                ...
                Button(
                    ...
                    font=("Roboto", 13),
                    fg="#1877F2",
                    command=lambda: messaging.destroy(),
                ).grid(row=3, column=0, pady=3, sticky="W")
    ...
    def create_a_page(self):
        ...
        Label(pg_frame, text="Page Name", font=("Roboto", 15), padx=7).grid(
            row=0, column=0, columnspan=2, padx=4, pady=(7, 0), sticky="W"
        )
        Label(pg_frame, text="Page Category", font=("Roboto", 15), padx=7).grid(
            row=2, column=0, columnspan=2, padx=4, pady=7, sticky="W"
        )
        Label(pg_frame, text="Page Description", font=("Roboto", 15), padx=7).grid(
            row=7, column=0, columnspan=2, padx=4, pady=7, sticky="W"
        )
        ...
        Radiobutton(
            ...
            variable=pgcat,
            font=("Helvetica 18 bold", 12),
            value="Brand or Product",
            fg="#1877F2",
        ).grid(row=4, column=0, pady=4, sticky="W")
        Radiobutton(
            pg_frame,
            text="Artist or Public Figure",
            variable=pgcat,
            font=("Helvetica 18 bold", 12),
            value="Artist or Public Figure",
            fg="#1877F2",
        ...
        def create_now():
            ...
            if pgname.index("end") == 0 or pgdescription.index("end") == 0:
                ...
                Label(
                    pg_frame,
                    text="Page Created.",
                    font=("Helvetica 18 bold", 14),
                    padx=18,
                    pady=4,
                    bd=1,
                    relief="groove",
                ).grid(row=9, column=0, columnspan=3, pady=7, sticky="W")
                # Back.
                Button(
                    pg_frame,
                    text="Back",
                    ...
                    width=9,
                    fg="#1877F2",
                    command=lambda: paging.destroy(),
                ).grid(row=10, column=0, columnspan=3, pady=7, sticky="W")
    ...
    def display_page(self, page_id):
        ...
        def like_page_now(page_to_like_ID):
            ...
            if owner:
                ...
                Label(
                    lp_frame, text="Page Liked.", font=("Roboto", 14), relief="groove"
                ).grid(row=1, column=0, pady=3, sticky="W")
            else:
                lpb = Button(
                    lp_frame,
        ...
        Label(dpi_frame, text="Name:", font=("Roboto", 13)).grid(
            row=1, column=0, pady=3, sticky="W"
        )
        Label(dpi_frame, text=name, font=("Helvetica", 13)).grid(
            row=1, column=1, pady=3, sticky="W"
        )
        Label(dpi_frame, text="Created By: ", font=("Roboto", 13)).grid(
            row=2, column=0, pady=3, sticky="W"
        )
        Label(
            dpi_frame, text=creator_first + "" + creator_last, font=("Helvetica", 13)
        ).grid(row=2, column=1, pady=3, sticky="W")
        Label(dpi_frame, text="Created On: ", font=("Roboto", 13)).grid(
            row=3, column=0, pady=3, sticky="W"
        )
        Label(dpi_frame, text=created_date, font=("Helvetica", 13)).grid(
            row=3, column=1, pady=3, sticky="W"
        )
        Label(dpi_frame, text="Category: ", font=("Roboto", 13)).grid(
            row=4, column=0, pady=3, sticky="W"
        )
        Label(dpi_frame, text=category, font=("Helvetica", 13)).grid(
            row=4, column=1, pady=3, sticky="W"
        )
        Label(dpi_frame, text="Description: ", font=("Roboto", 13)).grid(
            row=5, column=0, pady=3, sticky="W"
        )
        Label(dpi_frame, text=page_des, font=("Helvetica", 13)).grid(
        ...
        if has_posts:
            ...
            description_label1 = Label(
                dpp_frame,
                text=psdescription1[post_num - 1],
                font=("Helvetica bold 18", 13),
                padx=7,
                pady=3,
            )
            name_label = Label(
                dpp_frame,
                text="Posted by " + psfirst[post_num - 1] + " " + pslast[post_num - 1],
                font=("Roboto", 13),
                padx=7,
                pady=3,
            )
            ...
            def forward(p_num):
                ...
                name_label = Label(
                    dpp_frame,
                    text="Posted by " + psfirst[p_num - 1] + " " + pslast[p_num - 1],
                    font=("Roboto", 13),
                    padx=7,
                    pady=3,
                )
                ...
                button_comment = Button(
                    ...
                    font=("Roboto", 13),
                    fg="#1877F2",
                    command=lambda: Post.comment_on_a_post(
                        ps_postid[p_num - 1], ps_userid[p_num - 1], self
                    ),
                )
            ...
            button_comment = Button(
                ...
                fg="#1877F2",
                command=lambda: Post.comment_on_a_post(
                    ps_postid[post_num - 1], ps_userid[post_num - 1], self
                ),
            )
        ...
        if not has_posts:
            Label(dpp_frame, text="Page has no posts.", font=("Roboto", 14)).grid(
        ...
        def info_entered(name):
            ...
            if pages_to_find:
                ...
                Button(
                    ...
                    font=("Roboto", 13),
                    fg="#1877F2",
                    command=lambda: search_page_win.destroy(),
                ).grid(row=3, column=0, pady=3, sticky="W")
    ...
    def display_user_profile(self, ID):
        ...
        with open("Users_Database.csv") as data_file:
            ...
            for row in csv_reader:
                if row[0] == ID:
                    Label(
                        pi_frame, text=f"{row[1]} {row[2]}", font=("Roboto", 12)
                    ).grid(row=0, column=0, pady=3, sticky="W")
                    about = row[7]
                    current_city = row[8]
                    education = row[9]
        ...
        Label(pi_frame, text="About:", font=("Roboto", 12)).grid(
            row=1, column=0, pady=3, sticky="W"
        )
        Label(pi_frame, text=about, font=("Helvetica", 12)).grid(
            row=1, column=1, pady=3, sticky="W"
        )
        Label(pi_frame, text="Current City: ", font=("Roboto", 12)).grid(
            row=2, column=0, pady=3, sticky="W"
        )
        Label(pi_frame, text=current_city, font=("Helvetica", 12)).grid(
            row=2, column=1, pady=3, sticky="W"
        )
        Label(pi_frame, text="education: ", font=("Roboto", 12)).grid(
            row=3, column=0, pady=3, sticky="W"
        )
        Label(pi_frame, text=education, font=("Helvetica", 12)).grid(
            row=3, column=1, pady=3, sticky="W"
        )
        Label(pi_frame, text="workplace: ", font=("Roboto", 12)).grid(
            row=4, column=0, pady=3, sticky="W"
        )
        Label(pi_frame, text=workplace, font=("Helvetica", 12)).grid(
            row=4, column=1, pady=3, sticky="W"
        )
        Label(pi_frame, text="Relationship status: ", font=("Roboto", 12)).grid(
            row=5, column=0, pady=3, sticky="W"
        )
        Label(pi_frame, text=status, font=("Helvetica", 12)).grid(
            row=5, column=1, pady=3, sticky="W"
        )
        ...
        if not private_account:
            ...
            if has_posts:
                ...
                description_label2 = Label(
                    up_frame,
                    text=psdescription2[post_num - 1],
                    font=("Helvetica bold 18", 13),
                    padx=7,
                    pady=3,
                )
            ...
            if not has_posts:
                Label(up_frame, text="User has no posts.", font=("Roboto", 14)).grid(
                    row=0, column=0, pady=3, sticky="W"
                )
        else:
            ...
            if friends:
                ...
                if not has_posts:
                    Label(
                        up_frame, text="User has no posts.", font=("Roboto", 14)
                    ).grid(row=0, column=0, pady=3, sticky="W")
            else:
                # You can't view user's post.
                Label(up_frame, text="You can't view posts.", font=("Roboto", 14)).grid(
                    row=0, column=0, pady=3, sticky="W"
                )
    ...
    def accept_decline_friend_request(self):
        ...
        def accept_request(friend_request_no, sen_ID, row_no):
            ...
            for lst in range(len(lines)):
                if (
                    lines[lst][3] == str(self.ID)
                    and lines[lst][6] == str(True)
                    and lines[lst][0] == sen_ID[int(friend_request_no) - 1]
                ):
                    lines[lst][4], lines[lst][5], lines[lst][6] = (
                        self.first_name,
                        self.last_name,
                        False,
                    )
        ...
        def take_action(row_no):
            ...
            acb = Button(
                ...
                command=lambda: accept_request(
                    request_to_accept.get(), sender_id, row_no
                ),
            )
            ...
            deb = Button(
                ...
                bg="#1877F2",
                fg="white",
                command=lambda: decline_request(
                    request_to_reject.get(), sender_id, row_no
                ),
            )
            ...
            with open("Friends.csv") as friend_file:
                ...
                for row in csv_reader:
                    if row[3] == str(self.ID) and row[6] == str(True):
                        Label(
                            ad_frame,
                            text=f"You've a new friend request\nfrom {row[1]} {row[2]}.",
                            font=("Roboto", 13),
                            padx=20,
                            pady=5,
                            bd=1,
...
def gui(obj):
    ...
    global loginButton
    loginButton = Button(
        myFrame, text="Login", padx=35, pady=10, font=("Roboto", 14), command=obj.login
    )
    Label(myFrame, text="OR", font="Roboto", fg="#1877F2").grid(
