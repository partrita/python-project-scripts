...
class AlarmsFrame(ttk.Frame):
    def __init__(self, parent, text):
        ...
        self.style.configure(
            style="Alarm_Set.TLabel", anchor="center", font=("Helvetica", 18, "bold")
        )
        ...
        self.checkbutton = ttk.Checkbutton(
            master=self, variable=self.variable_checkbutton, command=self.set_alarm
        )
...
class DayButton(ttk.Label):
    ...
    def __init__(self, parent, day_name, row, column):
        ...
        self.grid(row=row, column=column, sticky="news", padx=2, pady=2)
