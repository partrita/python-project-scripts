...
label = Label(
    root, text="Software Engineering Quiz ", width=28, height=4, font=("algerian", 15)
)
label.pack()
...
class Quiz:
    ...
    def ask_question(self):
        ...
        if answer.lower() == "yes":
            ...
            if (
                answer.lower()
                == "application of engineering principle to the design a software"
            ):
                self.score += 1
                print("correct")
            else:
        ...
        print(
            "Thankyou for Playing the Hacktoberfest quiz game, you attempted",
            self.score,
            "questions correctly!",
        )
    ...
    def validate_question_two(self, question_two_value):
        if (
            ...
            print("Wrong Answer2")
            print(
                "correct answer is application of engineering principle to the design a software. It is the Application of engineering principles to the design,development, and support of software and it helps to solve the challenges of low- quality software project. "
            )
        return (
            True
            if question_two_value.lower()
            == "application of engineering principle to the design a software"
            else False
        )
    ...
    def validate_question_three(self, question_three_value):
        if question_three_value.lower() == "software development life cycle":
            ...
            print("Wrong Answer2")
            print(
                "correct answer is software development life cycle. it is a method for designing, developing, and testing high-quality softwarte."
            )
        return (
            True
            if question_three_value.lower() == "software development life cycle"
    ...
    def validate_question_four(self, question_four_value):
        if question_four_value.lower() == "requirement ananlysis":
            ...
            print("Wrong Answer2")
            print(
                "correct answer is requirement ananlysis, as based on it developer design and developed the software."
            )
...
w1_label = Label(
    root,
    text="Question 1: What programming language was this quiz created in?",
    font=("arial", 10),
    width=100,
    height=4,
)
...
w2_label = Label(
    root,
    text="Question 2:What is software Engineering?",
    font=("arial", 10),
    width=200,
    height=4,
)
w2_label.pack()
question_two = ttk.Combobox(
    root,
    width=50,
    height=4,
    value=[
...
w3_label = Label(
    root,
    text="Question 3:what does SDLC stand for?",
    font=("arial", 10),
    width=200,
    height=4,
)
w3_label.pack()
question_three = ttk.Combobox(
    root,
    width=50,
    height=4,
    value=[
...
w4_label = Label(
    root,
    text="Question 4: First phase of software development is:",
    font=("arial", 10),
    width=200,
    height=4,
)
w4_label.pack()
question_four = ttk.Combobox(
    root,
    width=50,
    height=4,
    value=["Coding", "Testing", "Design", "Requirement ananlysis"],
)
...
my_label = Label(root, text="Score:")
my_label.pack()
