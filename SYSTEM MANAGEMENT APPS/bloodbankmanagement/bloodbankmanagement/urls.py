...
urlpatterns = [
    ...
    path(
        "logout", LogoutView.as_view(template_name="blood/logout.html"), name="logout"
    ),
    path("afterlogin", views.afterlogin_view, name="afterlogin"),
    path(
        "adminlogin",
        LoginView.as_view(template_name="blood/adminlogin.html"),
        name="adminlogin",
    ),
    ...
    path(
        "approve-donation/<int:pk>",
        views.approve_donation_view,
        name="approve-donation",
    ),
    path(
        "reject-donation/<int:pk>", views.reject_donation_view, name="reject-donation"
    ),
    path(
        "admin-request-history",
        views.admin_request_history_view,
        name="admin-request-history",
    ),
    path(
        "update-approve-status/<int:pk>",
        views.update_approve_status_view,
        name="update-approve-status",
    ),
    path(
        "update-reject-status/<int:pk>",
        views.update_reject_status_view,
        name="update-reject-status",
    ),
]
