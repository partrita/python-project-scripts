...
class FaceRecognition:
    ...
    def face_comparison(self, face_encoded, face_located):
        compare_face = face_recognition.compare_faces(
            self.known_encoded_faces, face_encoded
        )
