...
class App(ttk.Window):
    ...
    def __init__(self):
        ...
        self.button_top_level = AddAlarmClock(
            parent=self, button_function=self.start_top_level
        )
        ...
        self.button_top_level.place(relx=BUTTON["X"], rely=BUTTON["Y"], anchor="center")
