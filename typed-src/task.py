...
def create_parser():
    ...
    parser.add_argument(
        "toDo",
        default="ls",
        choices=["usage", "ls", "add", "del", "done", "report"],
        help="Enter command: usage, ls, add, del, done, report.",
    )
    parser.add_argument("-p", required=False, type=int, help="item priority")
    parser.add_argument(
        "-i", required=False, type=str, help="List item to add, remove, or mark done."
    )
    return parser
