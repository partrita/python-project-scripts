        ...
        try:
            if len(self.hotel_names) > 0:
                for i in self.hotel_names:
                    try:
                        hotel_name_element = i.find_element(
                        ...
                        score_element = i.find_element(
                            By.CSS_SELECTOR,
                            "div[data-testid='review-score'] div[class='b5cd09854e d10a6220b4']",
                        )
                        collections.append(
                            [hotel_name, hotel_price, score_element.text]
                        )

                    except StaleElementReferenceException:
                        print(
                            "Stale element reference exception occurred while retrieving hotel name."
                        )
