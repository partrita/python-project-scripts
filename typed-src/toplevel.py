...
class TopLevel(tk.Toplevel):
    def __init__(self, parent, hour_int, minute_int, ok_function, cancel_function):
        ...
        # The spinbox
        self.top_level_style.configure(
            style="PAUSE.TLabel", font=("Helvetica", 20, "bold"), anchor="center"
        )
        self.top_level_style.configure(
        ...
        self.space_label = ttk.Label(master=self, style="PAUSE.TLabel", text=":")
        ...
        self.ok_button = ttk.Button(
            master=self, text="OK", style="OK.TButton", command=ok_function
        )
