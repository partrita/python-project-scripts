...
class CalculatorApp(ttk.Window):
    def __init__(self):
        ...
        self.Style.map(
            style="Number.TButton",
            background=[("active", "#4c9be8"), ("disabled", "#4c9be8")],
        )
        ...
        self.Style.map(
            style="Operator.TButton",
            background=[("active", "#4E5D6C"), ("disabled", "#4E5D6C")],
        )
        ...
        self.Style.map(
            style="Symbol.TButton",
            background=[("active", "#F0AD4E"), ("disabled", "#F0AD4E")],
        )
    ...
    def set_title_bar_color(self) -> None:
        ...
        try:
            ...
            windll.dwmapi.DwmSetWindowAttribute(
                HWND, DWMWA_ATTRIBUTE, byref(c_int(TITLE_BAR_COLOR)), sizeof(c_int)
            )
        except Exception:
            pass
