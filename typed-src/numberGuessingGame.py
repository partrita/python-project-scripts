...
def display_gameplay():
    ...
    print(
        "In this game you've just 7 trials to guess a number between the range of 1-10"
    )
...
def game():
    ...
    while play_game == "YES" or play_game == "Y":
        ...
        while user_input not in accepted_number_picks and user_input != "EXIT":
            print("Invalid Input!")
            user_input = (
                input("\nGuess a valid number between the range of 1-10: ")
                .strip()
                .upper()
            )
        if user_input == "EXIT":
            ...
            if user_input < computer_number:
                ...
                number_of_trials -= 1
                print(
                    f"Congratulations!!..you guessed right, after {7 - number_of_trials} trial(s)"
                )
                play_game = (
