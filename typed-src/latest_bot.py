    ...
    def run(self):
        ...
        for comment in reddit.subreddit("bitcoin").stream.comments():
            ...
            if sent.polarity != 0.0:
                ...
                print(
                    " ********** Total Sentiment is currently: "
                    + str(round(Average(lst_reddit), 4))
                    + " and there are "
                    + str(len(lst_reddit))
                    + " elements in reddit"
                )
                ...
                candles = client.get_historical_klines(
                    TRADE_SYMBOL, Client.KLINE_INTERVAL_1MINUTE, "1 Minutes ago UTC"
                )
                ...
                if (
                    df.iloc[-1] < LOWER_BAND
                    and round(Average(lst)) > 0.2
                    and len(lst) > 15
                ):
                    # if in_position:
            ...
            for response_line in response.iter_lines():
                if response_line:
                    ...
                    if sent.polarity != 0.0:
                        ...
                        print(
                            " ********** Total Sentiment is currently: "
                            + str(round(Average(lst_twitter), 4))
                            + " and there are "
                            + str(len(lst_twitter))
                            + " elements in twitter"
                        )
                        ...
                        if (
                            round(Average(lst_twitter)) > 0.2
                            and len(lst_twitter) > neededSentiments
                            and Fearandgreed() < 40
                        ):
                            # if in_position:
                            #     print("***** BUY ***** but we own!")
