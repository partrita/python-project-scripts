...
parser = argparse.ArgumentParser(
    description="Take a directory path or a filename and calculate those sizes in KB"
)
...
group.add_argument(
    "-d", action="store_true", help="Directory name for calculate size in KB"
)
group.add_argument(
    "-f", action="store_true", help="File name for calculate file size in KB"
)
